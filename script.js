...
document.getElementById('siBtn').addEventListener('click', function() {
    ...
    document.getElementById('messageContainer').style.fontSize = '3vh';
    document.getElementById('messageContainer').innerHTML = '¡Oh Siii! <br>Tus palabras me llenan de felicidad. <br>Este San Valentín será inolvidable a tu lado.';
